...
// Defina os filtros para cada campo em um array associativo
$filters = [
    "nome_cliente" => FILTER_SANITIZE_STRING,
    "email_cliente" => FILTER_SANITIZE_STRING,
    "senha_cliente" => FILTER_SANITIZE_STRING
];

// Receba os dados usando filter_input_array
$dados = filter_input_array(INPUT_POST, FILTER_DEFAULT);
var_dump($dados);

    // Acesso aos dados recebidos
